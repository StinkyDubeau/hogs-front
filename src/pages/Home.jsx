        ...
        <Frame noNavbar noCornerNav noPad>
                ...
                {showButtons && (
                    <div>
                        ...
                        <motion.div
                            layoutScroll
                            layoutId="buttons"
                            className="flex w-fit flex-wrap justify-center"
                        >
            ...
            <div className="h-screen rounded-lg text-slate-200">
                <motion.div
                    ...
                    onViewportEnter={() => setShowButtons(false)}
                        ...
                        <Button className="bg-[#ffffff22] backdrop-blur-xl hover:z-50 hover:scale-105 hover:bg-[#f351b2]">
                            ...
                            >
                                <div className="flex gap-2">
                                    ...
                                    <p className="text-2xl">Join the Discord</p>
                                </div>
                            </a>
                        </Button>
                        <div>
            ...
            >
                ...
                <Glass id="nonlinear">
                    <FadeInSection>
                        <div className="my-5 justify-between gap-6 md:flex">
                            <div>
