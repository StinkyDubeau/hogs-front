...
export default function Polaroid(props) {
    ...
    return (
        <div className="w-60">
            <Link to={props.to}>
                <div className={`bg-slate-100 flex-col p-2 w-60 h-80 shadow-md hover:shadow-xl hover:scale-105 rotate-${props.rotate} -rotate-${props.backrotate} hover:rotate-0 transition-all`}>
